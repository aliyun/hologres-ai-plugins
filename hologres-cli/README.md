...
Videos are generated by Hologres AI function using HappyHorse models and saved to an OSS volume via `to_file()`. A volume must be configured first (see `hologres volume create`). Video generation is asynchronous and typically takes 1-5 minutes.
